...
const MASONRY = [
  ...
  },
  {
    ...
    icon: "🗣️",
    title: "Speaks Hindi",
    desc: "All responses are in Hindi — the language farmers actually understand and trust.",
    size: "normal",
  },
  {
    type: "stat",
  ...
  },
  {
    ...
    icon: "🌐",
    title: "Works Offline",
    desc: "Core features like crop disease detection work without internet — built for rural India.",
    size: "normal",
  },
  {
    type: "quote",
  ...
  },
  {
    ...
    icon: "🤝",
    title: "Expert Backed",
    desc: "AI trained on data from veterinarians and agricultural scientists across India.",
    size: "normal",
  },
  {
    type: "stat",
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 1200px) { 
          ...
          .right-col { padding: 60px 0 80px !important; }
          .right-col > div { width: clamp(300px, 40vw, 420px) !important; height: clamp(380px, 52vw, 580px) !important; margin-right: clamp(0px, 10vw, 180px) !important; margin-left: 0 !important; }
          .right-col iframe { top: clamp(-40px, -5vw, -60px) !important; left: clamp(-120px, -15vw, -180px) !important; width: clamp(calc(100% + 240px), calc(100% + 30vw), calc(100% + 360px)) !important; height: clamp(calc(100% + 80px), calc(100% + 10vw), calc(100% + 120px)) !important; }
        }
      ...
      >
        ...
        <div className="marquee-strip">
          <CurvedLoop
            marqueeText="🌾 KRISHI MITRA &nbsp;•&nbsp; YOUR FARMING COMPANION &nbsp;•&nbsp; AI POWERED &nbsp;•&nbsp; INDIA FARMERS &nbsp;•&nbsp; CROP DOCTOR &nbsp;•&nbsp; LIVESTOCK CARE &nbsp;•&nbsp;"
            speed={1.4}
            curveAmount={0}
            direction="left"
            interactive={true}
        ...
        >
          ...
          >
            ...
            >
              Modern solutions, AI technology, and expert support to help India
              farmers grow more.
            </p>
          ...
          >
            <div
              style={{
                ...
                overflow: "visible",
                marginRight: "clamp(0px, 8vw, 240px)",
                marginLeft: 0,
                padding: "20px",
              }}
            >
              ...
              <iframe
                ...
                style={{
                  ...
                  width:
                    "clamp(calc(100% + 240px), calc(100% + 36vw), calc(100% + 360px))",
                  height:
                    "clamp(calc(100% + 100px), calc(100% + 16vw), calc(100% + 120px))",
                  border: "none",
                  display: "block",
                  background: "transparent",
                  pointerEvents: "none",
        ...
        >
          ...
          >
            Join thousands of Indian farmers already using KrishiMitra to
